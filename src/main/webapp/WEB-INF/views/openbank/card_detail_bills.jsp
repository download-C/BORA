...
<h3>상품구분</h3>
<h3>상품종류주3) "01"":일시불, "02":신용판매할부, "03":현금서비스</h3>
<hr>
   ...
   <div class="card-body px-0 py-0" >
    <div class="container">
	 <table  class="table table-hover" style="box-shadow: 7px 14px 90px 3px rgba(163, 174, 184, 0.7);">
		...
		<tr>
			<th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">카드식별값</th>
		...
		<c:forEach var="cardDetailBills" items="${cardDetailBills.bill_detail_list }">
			<tr>
				<td><span class="text-sm font-weight-normal">${cardDetailBills.card_value }</span></td>
