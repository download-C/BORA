...
<%-- 	<canvas id="myChart" width="400" height="400"></canvas> --%>
  ...
  <div class="container"
        ...
        <h4 style="text-align: center;"><%=loginID%>님의 매장별 소비 TOP3 </h4> <i class="fa-solid fa-ranking-star"></i>
    ...
    <div class="container"
        style="background-color: white; padding: 20px; border-radius: 15px; box-shadow: 7px 14px 42px 3px rgba(163, 174, 184, 0.7);">
        <h4 style="text-align: center;"><%=loginID%>님 날짜별 소비 TOP3 </h4><i class="fa-solid fa-ranking-star"></i>
          <div class="table-responsive">
            <table class="table">
