...
public interface BookDAO {
	...
	public List<BookVO> getMonthBookList(int year, 
			int month, String loginID) throws Exception;

	public BookVO getMonthBook(int year, int month, 
	...
	public int getMonthBudget(String loginID, 
