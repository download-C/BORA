...
public class CardDetailBillsVO {
	...
	private String credit_free_amt; // 신용판매 수수료
	...
	public CardDetailBillsVO(String card_value, String paid_date, String paid_time, String paid_amt,
			String merchant_name_masked, String credit_free_amt, String product_type) {
		super();
		...
		this.credit_free_amt = credit_free_amt;
	...
	public String toString() {
		return "CardDetailBillsVO [card_value=" + card_value + ", paid_date=" + paid_date + ", paid_time=" + paid_time
				+ ", paid_amt=" + paid_amt + ", merchant_name_masked=" + merchant_name_masked + ", credit_free_amt="
				+ credit_free_amt + ", product_type=" + product_type + "]";
	}
