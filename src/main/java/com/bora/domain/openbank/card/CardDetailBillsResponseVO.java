...
public class CardDetailBillsResponseVO {
	...
	private List<CardDetailBillsVO> bill_detail_list;
	...
	public String getBill_detail_cnt() {
		return bill_detail_cnt;
	}
	public void setBill_detail_cnt(String bill_detail_cnt) {
		this.bill_detail_cnt = bill_detail_cnt;
	}
	public List<CardDetailBillsVO> getBill_detail_list() {
		return bill_detail_list;
	}
	public void setBill_detail_list(List<CardDetailBillsVO> bill_detail_list) {
