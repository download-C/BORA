...
public class CardBillsResponseVO {
	...
	private String bill_cnt; // 현재 페이지 조회 건수
	private List<CardBillsVO> bill_list; // 청구목록
	
	public CardBillsResponseVO() {}
	
	public CardBillsResponseVO(String api_tran_id, String api_tran_dtm, String rsp_code, String rsp_message,
			...
			String bill_cnt, List<CardBillsVO> bill_list) {
		super();
	...
	public String toString() {
		return "CardBillsResponseVO [api_tran_id=" + api_tran_id + ", api_tran_dtm=" + api_tran_dtm + ", rsp_code="
				...
				+ next_page_yn + ", befor_inquiry_trace_info=" + befor_inquiry_trace_info + ", bill_cnt=" + bill_cnt
				+ ", bill_list=" + bill_list + "]";
	}
